...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <aside
      ...
      } fixed inset-y-0 left-0 z-50 w-64 bg-background border-r border-border transition-transform duration-300 ease-in-out md:relative md:translate-x-0 shadow-xl md:shadow-none md:pe-4`}
    >
